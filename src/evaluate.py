...
def is_new_model_better(run, old_model, model_metric_name, maximize=True):
    ...
    metric_new_model = run.parent.get_metrics().get(model_metric_name)
    ...
    metric_new_model = float(metric_new_model)
...
if __name__ == '__main__':
    ...
    main(
        ...
        # TODO: will be needed if evaluate loads trained models for further evaluations
